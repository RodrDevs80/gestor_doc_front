...
const AdminPage = () => {
  ...
  return (
    ...
    <>
    {(loading || isDeleting) && <Loader title={isDeleting ? "Eliminando producto..." : "Cargando..."} />} 
            ...
            <tbody className="divide-y divide-[var(--background-color)]">
              { productos.length && productos.map((prod, i) => (
                <tr key={i} className="hover:bg-white/50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-12 w-12">
                        <img src={prod.imagenUrl} alt={prod.nombre} className="h-12 w-12 rounded-md object-cover" />
                      </div>
                      <div className="ml-4">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-[var(--text-secondary)]">{prod.id}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="flex items-center justify-center space-x-2">
                      <button aria-label="Adjuntar archivo" className="p-2 text-[var(--accent-color)] hover:bg-[var(--background-color)] rounded-full transition-colors" onClick={() => {
